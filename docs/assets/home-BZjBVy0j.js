import{r as n}from"./site-9X9KYeSo.js";const o="https://review.alphazonelabs.com/api/reviews/published";function r(e=""){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function l(e){const t=Math.max(1,Math.min(5,Number(e.rating||5)));return`
